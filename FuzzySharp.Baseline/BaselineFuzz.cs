...
using FuzzySharp.Baseline.SimilarityRatio;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.Composite;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.Simple;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.TokenAbbreviation;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.TokenDifference;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.TokenInitialism;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.TokenSet;
using FuzzySharp.Baseline.SimilarityRatio.Scorer.StrategySensitive.TokenSort;

namespace FuzzySharp.Baseline
{
    public static class BaselineFuzz
    {
        #region Ratio
        /// <summary>
